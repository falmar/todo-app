...
const Todo = ({edit, del, data}) => {
  return (
    <tr>
      ...
      <td>
        <button onClick={edit} className='button warning small' type='button'><i className='fa fa-pencil' /></button>
                &nbsp;
        <button onClick={del} className='button alert small' type='button'><i className='fa fa-trash' /></button>
      </td>
    </tr>
  )
}
